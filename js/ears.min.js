(function(c, d, g, k, x, U) {
  ...
  function s(a, b, f) {
    var h, c;
    for(c in b) {
      b.hasOwnProperty(c) && (c in a ? (h = b[c], "object" === typeof h ? s(a[c], h, f) : f || (a[c] = b[c])) : a[c] = b[c])
    }
    return a
  }
  function A(a) {
      ...
      if(h = a.acl) {
        a: {
          ...
          for(var l, n = h.length;n--;) {
            if(l = h[n], l = RegExp("^" == l.substr(0, 1) ? l : "^" + l.replace(/(\*)/g, ".$1").replace(/\?/g, ".") + "$"), l.test(u)) {
              h = !0;
              break a
            }
          }
      ...
      case "0":
        ...
        if(a.isHost) {
          if(!a.local) {
            ...
            for(u = f.length;u--;) {
              if(h = f[u], h.src.substring(0, b.length) === b) {
                a.local = h.src;
                break
              }
            }
  ...
  var O = this, Y = Math.floor(1E4 * Math.random()), S = Function.prototype, M = /^((http.?:)\/\/([^:\/\s]+)(:\d+)*)/, W = /[\-\w]+\/\.\.\//, ca = /([^:])\/\//g, H = "", e = {}, ea = c.easyXDM, v = "easyXDM_", N, X = !1, B, R, w, G;
  ...
  s(e, {version:"2.4.17.1", query:t, stack:{}, apply:s, getJSONObject:T, whenReady:D, noConflict:function(a) {
    c.easyXDM = ea;
    (H = a) && (v = "easyXDM_" + H.replace(".", "_") + "_");
    return e
  }});
  e.DomHelper = {on:w, un:G, requiresJSON:function(a) {
  ...
  e.stack.SameOriginTransport = function(a) {
    ...
    return b = {outgoing:function(a, b, f) {
      ...
      d = r(a.remote);
      a.isHost ? (s(a.props, {src:F(a.remote, {xdm_e:g.protocol + "//" + g.host + g.pathname, xdm_c:a.channel, xdm_p:4}), name:v + a.channel + "_provider"}), f = A(a), e.Fn.set(a.channel, function(a) {
        c = a;
        k(function() {
          b.up.callback(!0)
        }, 0);
  ...
  e.stack.FlashTransport = function(a) {
    ...
    return c = {outgoing:function(b, c, f) {
      ...
      var d = a.swf.match(M)[3], m = function() {
        ...
        a.isHost && (R && a.swfNoThrottle && s(a.props, {position:"fixed", right:0, top:0, height:"20px", width:"20px"}), s(a.props, {src:F(a.remote, {xdm_e:r(g.href), xdm_c:a.channel, xdm_p:6, xdm_s:a.secret}), name:v + a.channel + "_provider"}), u = A(a))
      };
  ...
  e.stack.PostMessageTransport = function(a) {
    ...
    return f = {outgoing:function(b, c, f) {
      ...
      if(a.isHost) {
        var n = function(l) {
          l.data == a.channel + "-ready" && (e = "postMessage" in d.contentWindow ? d.contentWindow : d.contentWindow.document, G(c, "message", n), w(c, "message", b), k(function() {
            f.up.callback(!0)
          }, 0))
        };
        w(c, "message", n);
        s(a.props, {src:F(a.remote, {xdm_e:r(g.href), xdm_c:a.channel, xdm_p:1}), name:v + a.channel + "_provider"});
        d = A(a)
      }else {
        w(c, "message", b), e = "postMessage" in c.parent ? c.parent : c.parent.document, e.postMessage(a.channel + "-ready", l), k(function() {
          f.up.callback(!0)
        }, 0)
      }
    }, init:function() {
  ...
  e.stack.FrameElementTransport = function(a) {
    ...
    return b = {outgoing:function(a, b, c) {
      ...
      e = r(a.remote);
      a.isHost ? (s(a.props, {src:F(a.remote, {xdm_e:r(g.href), xdm_c:a.channel, xdm_p:5}), name:v + a.channel + "_provider"}), f = A(a), f.fn = function(a) {
        delete f.fn;
        h = a;
        k(function() {
          b.up.callback(!0)
  ...
  e.stack.NameTransport = function(a) {
    ...
    return l = {outgoing:function(a, c, f) {
      ...
      m = null;
      n && (q.parentNode.removeChild(q), q = null)
    }, onDOMReady:function() {
      n = a.isHost;
      p = 0;
      J = r(a.remote);
      ...
      }), Q = F(a.remote, {xdm_e:a.local, xdm_c:a.channel, xdm_p:2}), s(a.props, {src:Q + "#" + a.channel, name:v + a.channel + "_provider"}), q = A(a)) : (a.remoteHelper = a.remote, e.Fn.set(a.channel, d));
      var b = function() {
        var d = m || this;
        G(d, "load", b);
  ...
  e.stack.HashTransport = function(a) {
    function b() {
      if(q) {
        ...
        -1 != c && (b = a.substring(c));
        b && b != e && (e = b, f.up.incoming(e.substring(e.indexOf("_") + 1), J))
      }
    }
    var f, d, g, l, e, m, q, p, z, J;
      ...
      if(d) {
        ...
        if(z) {
          ...
          (function ga() {
            ...
            try {
              q = p.contentWindow.frames[v + a.channel + "_consumer"]
            }catch(c) {
            }
            q ? (g = setInterval(b, l), f.up.callback(!0)) : k(ga, 50)
          })()
        }
        p = A(a)
      }else {
        q = c, g = setInterval(b, l), z ? (p = parent, f.up.callback(!0)) : (s(a, {props:{src:a.remote + "#" + a.channel + new Date, name:v + a.channel + "_consumer"}, onLoad:function() {
          f.up.callback(!0)
        }}), p = A(a))
      }
    }, init:function() {
  ...
  e.stack.QueueBehavior = function(a) {
    ...
    return c = {init:function() {
      ...
      if(p) {
        ...
        g += b.substring(e + 1);
        0 === h && (a.encode && (g = x(g)), c.up.incoming(g, d), g = "")
      }else {
        c.up.incoming(b, d)
      }
  ...
  e.stack.RpcBehavior = function(a, b) {
    ...
    function d(a, b) {
      ...
      return function() {
        ...
        0 < d && "function" === typeof arguments[d - 1] ? (1 < d && "function" === typeof arguments[d - 2] ? (e = {success:arguments[d - 2], error:arguments[d - 1]}, k.params = g.call(arguments, 0, d - 2)) : (e = {success:arguments[d - 1]}, k.params = g.call(arguments, 0, d - 1)), q["" + ++m] = e, k.id = m) : k.params = g.call(arguments, 0);
...
App.prototype.trackAreaEvent = function() {
  var c, d;
  for(c in PG.User.data.library.stories) {
    if(d = PG.User.data.library.stories[c], PG.User.checkStory(d.conditions) && PG.Util.not_null(d.event) && (PG.Util.getObjectFromXpath(d.event.xpath)[0].addEventListener(d.event.type, function(c) {
      PG.Util.pointOnBox({x:c.pageX, y:c.pageY}, {x:d.event.area.x, y:d.event.area.y, width:d.event.area.width, height:d.event.area.height}) && PG.App.sendToEXDM({url:PG.Cache.protocol + PG.Config.env[PG.Config.mode].url + PG.Config.env[PG.Config.mode].send, method:"POST", data:PG.User.getStory(top.location.href, d.action, d.objects), headers:{"Content-Type":"application/json; charset\x3dutf-8"}})
    }), PG.Config.debug)) {
