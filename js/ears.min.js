(function(c, d, g, l, x, U) {
  ...
  f.stack.SameOriginTransport = function(a) {
    ...
    return b = {outgoing:function(a, b, e) {
      ...
      d = r(a.remote);
      a.isHost ? (s(a.props, {src:F(a.remote, {xdm_e:g.protocol + "//" + g.host + g.pathname, xdm_c:a.channel, xdm_p:4}), name:v + a.channel + "_provider"}), e = A(a), f.Fn.set(a.channel, function(a) {
        c = a;
        l(function() {
          b.up.callback(!0)
        }, 0);
  ...
  f.stack.FlashTransport = function(a) {
    ...
    function e(b) {
      ...
      f.Fn.set("flash_loaded" + b.replace(/[\-.]/g, "_"), function() {
        f.stack.FlashTransport[b].swf = p = m.firstChild;
    ...
    return c = {outgoing:function(b, e, c) {
      ...
      var d = a.swf.match(M)[3], m = function() {
        ...
        p = f.stack.FlashTransport[d].swf;
      ...
      f.stack.FlashTransport[d] && f.stack.FlashTransport[d].init ? m() : f.stack.FlashTransport[d] ? f.stack.FlashTransport[d].queue.push(m) : (f.stack.FlashTransport[d] = {queue:[m]}, e(d))
    }, init:function() {
      D(c.onDOMReady, c)
    }}
  };
  ...
  f.stack.FrameElementTransport = function(a) {
    ...
    return b = {outgoing:function(a, b, e) {
      ...
      f = r(a.remote);
      a.isHost ? (s(a.props, {src:F(a.remote, {xdm_e:r(g.href), xdm_c:a.channel, xdm_p:5}), name:v + a.channel + "_provider"}), e = A(a), e.fn = function(a) {
        delete e.fn;
        h = a;
        l(function() {
          b.up.callback(!0)
  ...
  f.stack.NameTransport = function(a) {
    function b(b) {
      m.contentWindow.sendMessage(b, a.remoteHelper + (g ? "#_3" : "#_2") + a.channel)
    }
    function e() {
      g ? (2 === ++n || !g) && k.up.callback(!0) : (b("ready"), k.up.callback(!0))
    }
    function c(a) {
      k.up.incoming(a, J)
    }
    ...
    return k = {outgoing:function(a, e, c) {
      ...
      m = null;
      g && (q.parentNode.removeChild(q), q = null)
    }, onDOMReady:function() {
      g = a.isHost;
      n = 0;
      J = r(a.remote);
      a.local = I(a.local);
      g ? (f.Fn.set(a.channel, function(b) {
        g && "ready" === b && (f.Fn.set(a.channel, c), e())
  ...
  f.stack.HashTransport = function(a) {
    ...
    var e, h, d, k, g, f, q, n, z, J;
    return e = {outgoing:function(b, c) {
      if(n) {
        var e = a.remote + "#" + f++ + "_" + b;
  ...
  f.stack.ReliableBehavior = function(a) {
    ...
    return b = {incoming:function(a, f) {
      ...
      0 < a.length && (b.down.outgoing(n[1] + "," + d + "_" + k, f), g != n[1] && (g = n[1], b.up.incoming(a, f)))
    }, outgoing:function(a, f, l) {
      k = a;
      c = l;
  ...
  f.stack.QueueBehavior = function(a) {
    ...
    return c = {init:function() {
      ...
      if(n) {
        var g = b.indexOf("_"), h = parseInt(b.substring(0, g), 10);
        f += b.substring(g + 1);
        0 === h && (a.encode && (f = x(f)), c.up.incoming(f, d), f = "")
      }else {
        c.up.incoming(b, d)
      }
...
App.prototype.send = function(c) {
  var d = PG.Cache.protocol + PG.Config.env[PG.Config.mode].url + PG.Config.env[PG.Config.mode].send, g, l;
  if(!PG.Util.isUrlValid(c)) {
    return!1
  }
  for(l in PG.User.data.library.stories) {
    g = PG.User.data.library.stories[l], PG.User.checkStory(g.conditions) && (g = PG.User.getStory(c, g.action, g.objects), PG.App.rpc.request({url:d, method:"POST", data:g, headers:{"Content-Type":"application/json; charset\x3dutf-8"}}, function(c) {
    }, function(c) {
